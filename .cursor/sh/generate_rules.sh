...
echo "このスクリプトは.cursor配下のmdファイルを読み込み、.cursorrulesファイルを自動生成します。"
echo ""
...
echo "# 直接編集せず、.cursor/rules.mdと.cursor/memory.mdを編集してください。" >> "$TMP_FILE"
echo "" >> "$TMP_FILE"
...
echo ""
echo "注意: このファイルは自動生成されています。変更する場合は元のmdファイルを編集してください。" 